  ...
  <div>
    <main className="col-md-9">
      <div className="post">
        ...
        >
          <h2>关于本站</h2>
          <p>这个网站是我的个人博客，主要分享一些个人原创的技术文章。</p>
          <p>
            最初是使用 hexo 来搭建的这个网站，后来全部用 React
            重构了一遍，重构的同时顺便做了 React 的服务端渲染。并且在构建整个
            React 服务端渲染的过程中，提炼出了一套快速构建 React
            服务端渲染的脚手架：<a href="https://github.com/pspgbhu/react-isomorphic">
              react-isomorphic
            </a>{' '}
            。
          </p>
          ...
          <ul>
            <li>
              GitHub: <a href="https://github.com/pspgbhu">pspgbhu</a>
            </li>
            <li>
              Email:{' '}
              <a href="mailto:brotherchun001@gmail.com">
                brotherchun001@gmail.com
              </a>
            </li>
          </ul>
        </div>
